...
function pauseActiveGameForVoiceNavigation() {
    ...
    const SALUTE_INTENTS = {
      ...
      SOUND_ON: {
        ...
        phrases: ["звуковые эффекты включи", "включи звук", "включи звуки", "звук включи", "звуки включи", "хочу звук", "верни звук"],
        reply: "Звуки включены.",
        run: () => { if (!state.settings.sound) toggleSetting("sound"); }
      },
      SOUND_OFF: {
        title: "Выключить звуки",
        phrases: ["звуковые эффекты выключи", "выключи звук", "выключить звук", "выключи звуки", "звук выключи", "звуки выключи", "без звука", "убери звук", "тишина"],
